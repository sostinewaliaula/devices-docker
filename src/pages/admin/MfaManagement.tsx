...
const MfaManagement: React.FC = () => {
  ...
  const getRoleBadge = (role: string) => {
    const colors = {
      admin: 'bg-primary/10 text-primary dark:bg-primary/20 dark:text-accent',
      manager: 'bg-secondary/10 text-secondary dark:bg-accent/15 dark:text-accent',
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-100 dark:bg-gray-950 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-card p-6">
          <div className="flex items-center">
            <div className="p-2 bg-brand-orange/15 dark:bg-brand-orange/20 rounded-lg">
              <KeyIcon className="w-6 h-6 text-brand-orange" />
            </div>
            <div className="ml-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-secondary dark:focus:ring-accent focus:border-transparent"
            />
          </div>
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-secondary dark:focus:ring-accent focus:border-transparent"
          >
          ...
          <button
            onClick={loadUsers}
            className="flex items-center justify-center gap-2 px-4 py-2 bg-action text-on-action rounded-lg hover:opacity-90 transition-colors"
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  {loadingFactors && (
                    <RefreshCwIcon className="w-4 h-4 animate-spin text-secondary dark:text-accent" />
                  )}
                </div>

                {loadingFactors ? (
                  <div className="text-center py-4">
                    <RefreshCwIcon className="w-6 h-6 animate-spin text-secondary dark:text-accent mx-auto mb-2" />
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="p-1 text-primary hover:text-primary/80 hover:bg-primary/10 dark:hover:bg-primary/30 rounded transition-colors disabled:opacity-50"
                          >
            ...
            <div className="p-6">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-primary/10 dark:bg-primary/20 rounded-full flex items-center justify-center flex-shrink-0">
                  <AlertTriangleIcon className="w-5 h-5 text-primary dark:text-accent" />
                </div>
